...
var WSDL = function () {
  function WSDL(definition, uri, options) {
    _classCallCheck(this, WSDL);

    this.content = definition;
    assert(this.content != null && (typeof this.content === 'string' || _typeof(this.content) === 'object'), 'WSDL constructor takes either an XML string or definitions object');
    this.uri = uri;
    this._includesWsdl = [];
  ...
  _createClass(WSDL, [{
    ...
    value: function load(callback) {
      ...
      process.nextTick(function () {
        ...
        self.processIncludes(function (err) {
          ...
          if (services) {
            for (var _s in services) {
              services[_s].postProcess(self.definitions);
            }
          }
    ...
    key: '_processNextInclude',
    value: function _processNextInclude(includes, callback) {
      var self = this,
    ...
    key: 'processIncludes',
    value: function processIncludes(callback) {
    ...
    key: 'describeServices',
    value: function describeServices() {
      var services = {};
    ...
    key: 'xmlToObject',
    value: function xmlToObject(xml) {
      return root;
    }
  }, {
    key: '_parse',
    value: function _parse(xml) {
      var self = this,
          p = sax.parser(true),
          stack = [],
          root = null,
    ...
    key: '_fromXML',
    value: function _fromXML(xml) {
      this.definitions = this._parse(xml);
      this.xml = xml;
    }
  }, {
    key: '_fromServices',
    value: function _fromServices(services) {}
  }, {
    key: '_xmlnsMap',
    value: function _xmlnsMap() {
     ...
     */
    value: function load(uri, options, callback) {
    ...
    key: 'open',
    value: function open(uri, options, callback) {
      if (typeof options === 'function') {
        callback = options;
        options = {};
      }
    ...
    key: 'loadSystemSchemas',
    value: function loadSystemSchemas(callback) {
